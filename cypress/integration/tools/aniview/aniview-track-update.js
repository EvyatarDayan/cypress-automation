...
let trackUrl = 'https://events.apester.com/px.jpg?event=tpe_ad_start&thirdParty=Aniview&channelId=[AV_CDIM2]&interactionId=[AV_CDIM1]&referrer=[AV_CDIM8]&session_Id=[AV_CDIM3]&demand_id=[AV_CHANNELID]&monBidder=[AV_ADVERTISER_NAME]&campaignId=[AV_CDIM6]&canonicalUrl=[AV_URL]&dynamic_bid=[AVC_CPM]'
let allInvalid = [];
...
describe('Stage 1 - aniview update', () => {
    ...
    it('Step 2 - Report', () => {
        let invalidCount = allInvalid.length
