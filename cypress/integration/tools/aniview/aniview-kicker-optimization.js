...
let timeframe = currentDate+' '+selectedTime+':00'+' - ' +currentDate+' '+selectedTime+':00';
...
describe('Stage 1 - aniview update', () => {
    ...
    it('Step 3 - Get the numbers', () => {
            ...
            let viewabilityNoSC = cy.getText('.table > :nth-child(2) > :nth-last-child(2) > :nth-child(3)')
            firstLine.push(viewabilityNoSC)

            let viewabilityWithSC = cy.getText('.table > :nth-child(2) > :nth-last-child(1) > :nth-child(3)')
