...
let testPageName = 'testPage.html';
let aniviewChannelId = '5fad4ac42cd6d91dcb6e50e9';
let aniviewPlayerId = '5faf2a6e1b1ab26edc3f9173';
...
describe('Create video poll', () => {
    ...
    it('Add the engine', () => {
        cy
            ...
            .clickOn('.control__btn > .ic').waitFor(3000).clickOn('.control__btn > .ic') // start and stop the video
            .clickOn('.btn')    // click on add quiz button
            .typeValue('.video > .main-title > .ape-text-editor-wrapper > .ta-root', 'This is the question').waitFor(1000)   // Add the question
            ...
            .clickOn(':nth-child(2) > .options-wrapper > .option > .selected-option > .ng-valid-maxlength').waitFor(1000) // Click on answer 1
            .clickOn('.feedback-feeder__nav > .ape-dropdown > .ape-dropdown__label-wrapper > .ape-dropdown--label') // Click on dropdown list
...
describe('Stage 2 - create the campaign', () => {
    ...
    it('Publish the engine + campaign to a public web page (git?)', () => {
        cy
            ...
            .clickOn('#select_option_71 > .md-text').waitFor(1000)
            ...
            .clickOn('#select_value_label_10 > .md-select-icon').waitFor(500)
            // Select "Load"
