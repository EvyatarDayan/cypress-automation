...
describe('Create poll e2e', () => {
    ...
    it('Add the engine', () => {
        cy
            ...
            .typeValue('[max-length="180"] > .main-title > .ape-text-editor-wrapper > .ta-root', 'This is the poll title').waitFor(1000)    // Add poll title
            ...
            .scrollToPosition(0, 1000).waitFor(1000)
